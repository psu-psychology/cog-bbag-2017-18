...
This document provides some readings and R code to facilitate a discussion about a recent proposal by [Benjamin et al. 2017](http://rdcu.be/v4Sr) to change the conventional $\alpha$ value used in Null Hypothesis Significance Testing in psychological research. 
